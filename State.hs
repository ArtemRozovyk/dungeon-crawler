...
prop_state_inv e = 
    prop_state_inv1(e) && prop_state_inv2(e) && prop_state_inv3(e) && prop_state_inv4(e) 
...
prop_state_inv1 :: Etat -> Bool 
prop_state_inv1 etat@(Tour nt ct env gt ot lgt) =
    nt>=0

prop_state_inv2 :: Etat -> Bool
...
prop_pre_add_entity_state3 :: Etat -> Coord -> Entite -> Bool 
...
prop_pre_add_entity_state4 :: Etat -> Coord -> Entite -> Bool 
...
prop_post_add_entity_state :: Etat -> Coord -> Entite -> Bool 
